...
aws s3api put-object --bucket ${COMPONENTS_BUCKET_NAME} \
  --key artifacts/aws.sagemaker.edgeManagerClientCameraIntegration/0.1.0/camera_integration_edgemanger_client_opencv.py \
  --body components/camera_integration_edgemanger_client_opencv.py
